...
def wrapper_balltrack(args, data, filter_radius, ballspacing, outputdir):
    ...
    _, _ = blt.balltrack_all(nt, rs, dp, sigma_factor, intsteps, outputdir_args, fourier_radius=filter_radius, ballspacing=ballspacing, data=data, ncores=1)
    return outputdir
...
if __name__ == '__main__':
    ...
    with Pool(processes=nthreads) as pool:
        wrapper_partial = partial(wrapper_balltrack, data=images2, filter_radius=filter_radius, ballspacing=ballspacing, outputdir=outputdir)
