...
bt_params = {
    ...
    'trange': (0, 30),  # Time range (1st index, last index + 1) of the series of images to use for tracking.
    'verbose': True
}
...
maps_params = {
    ...
    'navg': 15,  # in nb of frame ~ must translate to ~30 min minimum with HMI @45s cadence
...
cal_args = {
    ...
    'trange': [0, 30],  # Indices of images to drift.
